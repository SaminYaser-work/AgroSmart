...
class LateTable extends BaseWidget
{

    protected static ?string $heading = 'Late Today';
    ...
    protected function getTableColumns(): array
    {
        return [
            ...
            Tables\Columns\TextColumn::make('late_by')
                ->label('Late By')
                ->getStateUsing(function (Attendance $record) {
                    $timeIn = Carbon::parse($record->time_in);
                    $shiftStart = Carbon::parse('08:00:00');
                    return $timeIn->diff($shiftStart)->format('%H:%I:%S');
                })
        ];
    }
